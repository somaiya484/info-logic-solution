    ...
    return (
        <div className="bg-[url('https://i.ibb.co/x72WQSy/Articles-Bg.webp')] ">
            ...
            <div className="bg-[url('https://i.ibb.co/FgNS1gz/City-Bg-2x.webp')] mt-7 pt-16 pb-32">
                ...
                <p className='primary-text text-center text-7xl text-gradient font-bold mt-20'>Contact Us Today</p>
                    ...
                    <div>
                        <form>
                            <div className="form-control mt-5">
                                <input type="text" placeholder="Name" name='name' className="input bg-white input-bordered border-2  focus:outline-none rounded-xl" required />
                            </div>
                            <div className="form-control mt-5">
                                <input type="email" placeholder="Email" name='email' className="input bg-white input-bordered border-2  focus:outline-none rounded-xl" required />
                            </div>
                            <div className="form-control mt-5">
                                <input type="tel" placeholder="Phone" name='phone' className="input bg-white input-bordered border-2  focus:outline-none rounded-xl" required />
                            </div>
                            <div>
                                <textarea className="input bg-white input-bordered mt-5 h-48 border-2  focus:outline-none rounded-xl pt-3" name="text" placeholder="Message" id="" cols={52}></textarea>
                            </div>

                            <input type="submit" value="Submit" className="btn w-[120px] border-orange-700 border-2 bg-transparent text-orange-700 hover:text-white form-control mt-3 text-[15px] font-semibold" />
                        </form>
                    </div>
                </div>
            </div>
